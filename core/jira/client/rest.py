...
from field_provider import jira_field_provider
from query_builder import JIRAQueryBuilder
...
class JIRARestClient:
    ...
    async def get_issues(
        ...
        try:
            url = f"{self.base_url}/rest/api/{self.jira_api_version}/search?jql={jql}&startAt={start_at}&maxResults={max_results}&fields={','.join(fields)}"
