...
Vocabulary bridge that converts operational Jira idea-card language into
the structured fields used for retrieval.
"""
...
from .prompts import build_value_stream_classification_prompt
...
def summarize_ticket(
    ...
    """Call the LLM and return a TicketSummaryDocument (VS labels and embedding excluded)."""
